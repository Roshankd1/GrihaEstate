...
/**
 * Created by roshank on 02/12/2017.
 */

public class FragmentShortLet extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.shortlet_layout, null);
    ...
    public void ShowPriceDialog() {
        ...
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.lettingrangedialog, null);

        final Spinner minletprice = view.findViewById(R.id.minletprice);
        final Spinner maxletprice = view.findViewById(R.id.maxletprice);

        view.findViewById(R.id.apply).setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {
                price.setText(minletprice.getSelectedItem().toString() + " to " + maxletprice.getSelectedItem().toString());
                pricedialog.dismiss();
            }
